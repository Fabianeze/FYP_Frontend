...
import { useLoginMutation } from "../../redux/api/slices/auth-api-slice";
            ...
            onSubmit={async (values) => {
              try {
                ...
                if (result) {
                  ...
                  if (values.account === "Fleet Manager") {
                    navigate("/manager/dashboard");
                  } else if (values.account === "Driver") {
              ...
              return (
                <Form className="flex justify-center pt-5">
                  <div className="flex flex-col w-[32rem] h-[30rem]">
                    ...
                    <div className="h-[3.1rem] mt-2">
                      <Select
                        special={false}
                        name="account"
                        roles={[
                          { option: "Account Type", value: "" },
                          { option: "Fleet Manager", value: "Fleet Manager" },
                    ...
                    <div>
                      <button type="submit" className="bg-[#470A34] text-[#FFFFFF] h-[2.95rem] rounded w-full mt-3 ">
                        Login
                      </button>
                    </div>
                    <div className="mt-2">
                      <a
                        className="text-[16px] text-[#470A34]"
                        href="/register"
                      >
                        Register as guest
                      </a>
